function [E0, G0] = MatrixVectorMultiply(x, S, Q, lambda_p, box, p1, p2, Ngrid, h, P, ...
...
% magnetic dipoles and quadrupoles.
%
% INPUTS
...
%
% OUTPUTS
% E0 = (N-by-3 array) external field at each particle
% G0 = (N-by-3 array) external field gradient at each particle

% Spread particle dipoles and quadrupoles (as vectors and tensors) to a regular grid
[HSx, HSy, HSz, HQxx, HQxy, HQxz, HQyy, HQyz] = Spread(x, S, Q, Ngrid, h, xi, eta, P, offset, offsetxyz);
...
[Ek,Gk] = Contract(x, Ngrid, h, xi, eta, P, HEtilde, HGtilde, offset, offsetxyz);

% Calculate the real space contribution to the field
[Er,Gr] = RealSpace(x, S, Q, lambda_p, box, p1, p2, rc, r_vals, field_dip_1, field_dip_2, ...
