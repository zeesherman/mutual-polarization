...
if r(1)==0
    ...
    % Potential/quadrupole or field gradient/charge
    pot_quad = [0;pot_quad];
    ...
    % Potential/quadrupole or field gradient/charge
    field_quad_1 = [0;field_quad_1];
    field_quad_2 = [0;field_quad_2];
    field_quad_3 = [0;field_quad_3];
    
    % Field gradient/quadrupole
    self = 1/(2*pi)*( 3*(3-10*xi^2+20*xi^4)/(8*sqrt(pi)*xi^5) - 3*(3+2*xi^2+4*xi^4)*exp(-4*xi^2)/(8*sqrt(pi)*xi^5) + 3*erfc(2*xi) );
    grad_quad_1 = [0;grad_quad_1];
    grad_quad_2 = [self;grad_quad_2];
    grad_quad_3 = [0;grad_quad_3];
    grad_quad_4 = [0;grad_quad_4];
