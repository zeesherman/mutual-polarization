function [Hmag] = MagneticField(x_E,x_p,m,box,p1,p2,Ngrid,h,P,xi,eta,rc,offset,offsetxyz,Hperp,Hpara,rvals)

% Computes the magnetic field at probe positions due to particle magnetic
% dipoles.
%
% INPUTS
...
[Hx,Hy,Hz] = Spread(x_p,m,Ngrid,h,xi,eta,P,offset,offsetxyz);
...
Hk = Contract(x_E,Ngrid,h,xi,eta,P,Htilde,offset,offsetxyz);

% Calculate the real space contribution to the field
Hr = RealSpace(x_E,x_p,m,box,p1,p2,rc,Hperp,Hpara,rvals);
